		...
		<div class="container">
			<nav class="navbar navbar-expand-lg ">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<div>
                        <form action="/admin/searchcustomer" class="form-inline" method="post">
                              {{ csrf_field() }}
                                <input class="form-control mr-sm-2" name="cname" type="search" placeholder="Search" aria-label="Search">
...
<br>
<h3 class="w3l_header">CUSTOMERS</h3> <br>
<div class="container">
    <div class="row">
        <div class="col">
        <table class="table">
            ...
            <tr>
                <td> {{ $register->cname }} </td>
                <td> {{ $register->cmob }} </td>
                <td> {{ $register->cemail }} </td>
            </tr>
            @endforeach
        </table>
        </div>
