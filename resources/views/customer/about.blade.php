		...
		<header>
			<div class="container">
				<div class="header-bottom-agileits">
					<div class="w3-logo">
						<h1><a href="/customer/index">La Belle</h1>
					</div>
	 				<div class="address">
						<p>4th block,</p>
			...
			<nav class="navbar navbar-expand-lg">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
				        ...
				        <li><a class="active" href="/customer/about">About</a></li>  
...
<div class="about">
	...
	<div class="wthree_head_section">
				...
				<p><i><b>Nothing makes a woman more beautiful than the belief that she is beautiful..</b></i></p>
			</div>
		<div class="ab-agile">
			<div class="col-md-6 aboutleft">
				<h3>Welcome to La Belle</h3>
				<p class="para1">
				At La Belle , we have confidence in excellence with a heart. 
				We have made a salon that offers the most noteworthy quality hair and skin benefits in a setting that is more advantageous for the customer,
				We make use of the top notch proficient hair and skin products for our customers that visit our salon. 
				The hair care items we convey have been cautiously picked put together both with respect to execution and eco-affectability.
                </p>
				<p><i class="fa fa-check" aria-hidden="true"></i> Frienldy Environment </p>
				<p><i class="fa fa-check" aria-hidden="true"></i> Makes you look beautiful </p>
				<p><i class="fa fa-check" aria-hidden="true"></i> Treats you with love and care </p>
				<p><i class="fa fa-check" aria-hidden="true"></i> Safe Hair and Makeup products </p>
				</div>
			<div class="col-md-6 aboutright">
				<img src="{{ asset('assets/images/raphael-lovaski-pxax5WuM7eY-unsplash.jpg') }}" class="img-responsive" alt="" />
			</div>

			<div class="col-md-6 aboutright">
				<img style="max-width:150px;margin-top:20px;" src="{{ asset('assets/images/img3.jpg') }}" class="img-responsive" alt=""/>
			</div>
...
<!-- wthree-mid -->
	<div class="wthree-mid jarallax">
		...
		<div class="container">
			<h3>La Belle Salon for the girls out there !</h3>
			<p>Treat yourself to a facial or celebrating a special occasion. Our beauty
