			...
			<div class="container">
				<div class="header-bottom-agileits">
					...
					<div class="nav-contact-w3ls">
						...
						<p> {{ $LoggedUserInfo['cemail'] }}</p>
						<p class="para-y"><a href="{{ route('auth.logout') }}">Logout</a></p>
					</div>
				</div>
			</div>
		</header>
			...
			<nav class="navbar navbar-expand-lg ">
				...
				<!-- Collect the nav links, forms, and other content for toggling -->
		 		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<li><a  class="active" href="/customer/index">Home</a></li>
	...
	<div class="practice-areas">
		<div class="container">
			<div class="wthree_head_section">
				<h3 class="w3l_header">Popular <span>Services</span></h3>
			...
			<div class="area-main">
				<div class="col-md-6 area-inner">
					...
					<div class="area-right p1">
						<h5>SPA</h5>
						<p class="para-w3-agile">To make your skin healthy and fresh</p>
					</div>
				</div>
				<div class="col-md-6 area-inner">
					<div class="area-img2">
					...
					<div class="area-right p2">
						<h5>MAKEUP</h5>
						<p class="para-w3-agile">To help you look outstanding for a special occassion </p>
					</div>
				</div>
			</div>
			<div class="area-main">
				<div class="col-md-6 area-inner">
					<div class="area-right p3">
						<h5>MANICURES</h5>
						<p class="para-w3-agile">To help your nails look clean and beautiful</p>
					</div>
					<div class="area-img3">
					</div>
				</div>
				<div class="col-md-6 area-inner">
					<div class="area-right p4">
						<h5>HAIR CARE</h5>
						<p class="para-w3-agile">Includes hair cutting and other services that help your hair to be nourished and healthy</p>
					</div>
					<div class="area-img4">
					</div>
				</div>
