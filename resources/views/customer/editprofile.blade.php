...
<div class="container">
     <div class="row">
       <div class="col col-12 c">
        ...
        <div class="row">
        <div class="col">
        <form action="/customer/profiledit/{{ $customers->id }}"  method="post">
        ...
        <div class="form-group">
          ...
          <input value="{{ $customers->cemail }}" type="email" class="form-control" name="cemail" id="cusname" required>
        </div>

		<div class="form-group">
			<label for="cusmob">Mobile</label>
			<input value="{{ $customers->cmob }}" type="number" class="form-control" name="cmob" id="cusmob"  required>
		</div>
