	...
	<div class="wthree_head_section">
		...
		<div class="ab-agile">
			...
			<div class="col-md-6 aboutright">
				<img src="assets/images/raphael-lovaski-pxax5WuM7eY-unsplash.jpg" class="img-responsive" alt="" />
			</div>

			<div class="col-md-6 aboutright">
				<img style="max-width:150px;margin-top:20px;" src="assets/images/img3.jpg" class="img-responsive" alt=""/>
			</div>
...
<!-- wthree-mid -->
	<div class="wthree-mid jarallax">
		<img class="jarallax-img" src="assets/images/33.jpg" alt="">
		<div class="container">
